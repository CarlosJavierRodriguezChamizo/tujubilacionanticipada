...
<BarChart
  ...
  unit="%"
  caption="Fuente: arts. 207 y 208 LGSS (RDL 8/2015). Involuntaria: coeficiente fijo 1,625 %/trim. × 16 trim. Voluntaria: coeficiente máximo 1,875 %/trim. × 8 trim."
  data={[
    { label: 'Voluntaria (2 años)', value: 15 },
    { label: 'Involuntaria (4 años)', value: 26, highlight: true },
  ]}
/>
